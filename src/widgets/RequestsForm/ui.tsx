...
export const RequestsForm = () => {
  ...
  return (
    <form className="w-[491px] h-[346px] flex flex-col gap-5 justify-between p-5 bg-white rounded-md">
      <h3 className="font-medium text-xl text-black">Send quote to suppliers</h3>
      ...
      <div className="flex items-start gap-2">
        ...
        <Select
          ...
          className="max-w-[111px] w-full border rounded-md border-gray-medium"
          isOpen={isOpen}
          defaultValue="Pcs"
          setOpen={setOpen}>
      ...
      <Button className="max-w-[128px] w-full" rounded="rounded-md">
        Send inquiry
      </Button>
    </form>
  )
