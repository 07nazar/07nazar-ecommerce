  ...
  return (
    <div className="mt-[20px] flex py-5 pl-3.5 pr-5 gap-5 mb-8 bg-white border border-gray-medium rounded-md">
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <AppLink
          to="/"
          className="text-white hover:text-gray-pale max-w-[200px] w-full h-[95px] pt-4 pr-10 pb-5 pl-4 leading-5 bg-orange rounded-md"
        >
          Get US $10 off with a new supplier
        </AppLink>
        <AppLink
          to="/"
          className="text-white hover:text-gray-pale max-w-[200px] w-full h-[95px] pt-4 pr-10 pb-5 pl-4 leading-5 bg-[#55BDC4] rounded-md"
        >
