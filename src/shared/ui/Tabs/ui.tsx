...
export const TabBtn: FC<ITabBtnProps> = ({
  ...
  const borderStyles = isActive && outlined ? 'border-b-2 border-blue rounded-none z-10' : ''
  ...
  return (
    <>
      <animated.button
        ...
        style={animation}
        className={`${buttonStyles} ${borderStyles} leading-5`}>
        {children}
      </animated.button>
      {outlined && (
        <span
...
export const Tabs: FC<ITabs> = ({ children, buttons, orientation = 'vertical', border = '' }) => {
