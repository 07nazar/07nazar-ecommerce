...
// Todo разбить логику на более мелкую, мб разделить на 2 компоненты ( для десктопа / для телефона )
  ...
  return (
    <div className={'flex lg:flex-col mt-5'}>
      <div
        ...
        <h5
          className={
            'text-black w-2/3 text-xl sm:text-lg leading-6.5 font-semibold mb-5 sm:mb-0'
          }>
          {title}
        </h5>
        {!isMobile && (
